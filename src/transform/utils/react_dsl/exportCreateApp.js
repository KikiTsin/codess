...
function exportCreateApp(schema, option) {
    ...
    `;
        ...
        // index.js
        const isGlobal = schema.css &&
            dslConfig.globalCss &&
            dslConfig.inlineStyle !== consts_1.CSS_TYPE.INLINE_CSS;
    ...
    `;
        panelDisplay.push({
            ...
            panelValue: prettier.format(panelValue, consts_1.prettierJsOpt),
            folder: 'src',
        });
        // index.css
        panelValue = ``;
        panelDisplay.push({
            panelName: `index.css`,
            panelType: 'css',
            panelValue: prettier.format(panelValue, consts_1.prettierCssOpt),
            folder: 'src',
        });
        // dependencies
        ...
        panelDisplay.push({
            ...
            panelType: 'json',
            panelValue: prettier.format(panelValue, consts_1.prettierJsonOpt),
...
exports.default = exportCreateApp;
