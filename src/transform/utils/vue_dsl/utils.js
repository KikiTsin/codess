...
exports.renderDefaultComps = exports.handleField = exports.transComponentsMap = exports.importString = exports.collectImports = void 0;
function collectImports(obj) {
    const { componentName, componentsMap, importsMap, dependenceList, components, } = obj;
...
const transComponentsMap = (insComponentsMap) => {
    let list = [];
...
const renderDefaultComps = (renderComps) => {
    const { children, componentsMap, importsMap, dependenceList, components } = renderComps;
    let xml = '';
...
exports.renderDefaultComps = renderDefaultComps;
